...
import { AvatarGroup, Box, Button, Card, Divider, Grid, IconButton, styled } from "@mui/material";
                      ...
                      <FlexBox alignItems="center">
                        ...
                        <Box>
                          ...
                          <FlexBox alignItems="center">
                            <Tiny mr={2}>3mb</Tiny>
                            <FlexBox alignItems="center">
                              <Box mr={1} width="4px" height="4px" borderRadius={1} bgcolor="text.disabled" display="inline-block" />
