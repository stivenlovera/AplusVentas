...
import { UseProducto } from "pages/ingredientes/hooks/useProducto";
        ...
        <Context.Provider value={[actualizarTable, setActualizarTableContext]}>
            <Box pt={2} pb={4}>
                <HeadingWrapper justifyContent="space-between" alignItems="center">
                    ...
                    <SearchInput bordered={'true'} placeholder="Buscar ingredientes" onChange={e => setSearchValue(e.target.value)} />
                ...
                <CreateProductoModal
                    ...
                    data={{
                        ...create,
                        initialState: { ...initialStateProducto, codigoProducto: create.codigoProducto, tipoProductoId: TipoProducto.INGREDIENTE }
                    }} />
